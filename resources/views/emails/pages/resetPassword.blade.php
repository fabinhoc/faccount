                    ...
                    <tbody>
                        <tr>
                            <td>
                                <table align="center" border="0" cellpadding="0" cellspacing="0"
                                    class="row-content stack" role="presentation"
                                    style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; color: #000000; background-color: #fff; width: 640px;"
                                    width="640">
                                    <tbody>
                                        <tr>
                                            <td class="column column-1"
                                                        ...
                                                        <td class="pad"
                                                            ...
                                                            <div align="center" class="alignment"
                                                                ...
                                                                <img alt="I'm an image"
                                                                    ...
                                                                    style="display: block; height: auto; border: 0; width: 254px; max-width: 100%;"
                                                                    title="I'm an image" width="254" />
                                                            </div>
                                                        </td>
                                                    </tr>
                                                </table>
                                                                ...
                                                                <div class=""
                                                                    ...
                                                                    <p style="margin: 0; font-size: 16px; text-align: center; mso-line-height-alt: 19.2px;">
                                                                        <span style="font-size:30px;color:#2b303a;">
                                                                            <strong>{{ __('email.resetPassword.title') }}</strong>
                                                                        </span>
                                                                    </p>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <td class="pad"
                                                            ...
                                                            <div style="font-family: sans-serif">
                                                                ...
                                                                >
                                                                    ...
                                                                    >
                                                                        <span
                                                                            style="color:#808389;font-size:15px;">{{ $line }}
                                                                        </span>
                                                                    </p>
                                                                    @endforeach
                                                                </div>
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0"
                                                    ...
                                                    <tr>
                                                        <td class="pad"
                                                            ...
                                                            <div align="center" class="alignment">
                                                                @isset($actionText)
                                                                    <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" style="height:62px;width:183px;v-text-anchor:middle;" arcsize="97%" stroke="false" fillcolor="#97d5c9"><w:anchorlock/><v:textbox inset="0px,0px,0px,0px"><center style="color:#ffffff; font-family:Tahoma, sans-serif; font-size:16px"><![endif]-->
                                                                    <a target="_blank" href="{{ $actionUrl }}" style="text-decoration:none;display:inline-block;color:#ffffff;background-color:#97d5c9;border-radius:60px;width:auto;border-top:0px solid transparent;font-weight:undefined;border-right:0px solid transparent;border-bottom:0px solid transparent;border-left:0px solid transparent;padding-top:15px;padding-bottom:15px;font-family:Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;font-size:16px;text-align:center;mso-border-alt:none;word-break:keep-all;">
                                                        ...
                                                        <td class="pad"
                                                            ...
                                                            <div style="font-family: sans-serif">
                                                                ...
                                                                >
                                                                    ...
                                                                    >
                                                                        <span
                                                                            style="color:#808389;font-size:15px;">{{ __('email.resetPassword.expireMessage') }}
                                                                        </span>
                                                                    </p>
                                                                    <p
                                                                        style="margin: 0; font-size: 14px; text-align: left; mso-line-height-alt: 22.5px;"
                                                                    >
                                                                        <span
                                                                            style="color:#808389;font-size:15px;">{{ __('email.resetPassword.noRequiredMessage') }}
                                                                        </span>
                                                                    </p>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <td class="pad"
                                                            ...
                                                            <div style="font-family: sans-serif">
                                                                ...
                                                                >
                                                                    ...
                                                                    >
                                                                        <span
                                                                            style="color:#808389;font-size:15px;">{{ __('email.resetPassword.thankfully') }}
                                                                        </span>
                                                                    </p>
                                                                    <p
                                                                        style="margin: 0; font-size: 14px; text-align: left; mso-line-height-alt: 22.5px;"
                                                                    >
                                                                        <span
                                                                            style="color:#808389;font-size:15px;">{{ config('app.name') }}
                                                                        </span>
                                                                    </p>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div style="font-family: sans-serif">
                                                                <div class=""
                                                                    ...
                                                                    <p style="margin: 0; font-size: 12px; mso-line-height-alt: 18px;">
                                                                        @lang('email.emailVerify.footerAction', ['actionText' => $actionText])
                                                                        <a target="_blank" href="{{ $actionUrl }}" class="break-all">{{ $actionUrl }}</a>
                                                                    </p>
                                                                </div>
                                                            </div>
                                                        </td>
